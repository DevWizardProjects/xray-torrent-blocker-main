...
var (
	...
	OnBlockCommand   string
	OnUnblockCommand string
)
...
type Config struct {
	...
	OnBlockCommand   string `yaml:"OnBlockCommand"`
	OnUnblockCommand string `yaml:"OnUnblockCommand"`
}
...
func LoadConfig(configPath string) error {
	...
	OnBlockCommand = cfg.OnBlockCommand
	OnUnblockCommand = cfg.OnUnblockCommand
